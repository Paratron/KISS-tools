...
class kTester {
    ...
    function __construct($css_path = 'kTester/kTester.css'){
    ...
    /**
     * Starts the testing and sets a global test title.
     * @param string $title
     * @return void
     */
    function start($title){
        ob_start(); //Avoid any output of data. Will be fetched later in the render() function.
        $this->title = $title;
    ...
    function group($groupname){
        ...
        $this->tests[] = array(
            ...
            'nearly_tests' => 0,
            'failed_tests' => 0,
            'tests' => array()); //Contains the single testing results
    }

    /**
     * Tests, if $evaluation is TRUE or FALSE. If FALSE, the test has failed.
     * Instead of passing in TRUE or FALSE, the result of a kTester eval function can be passed in for having more details available.
     * @param string $title Name des Tests
     * @param bool|mixed $evaluation
     * @return bool
     */
    ...
    <head>
        ...
        <link href="<?= $this->css_path ?>" rel="stylesheet" type="text/css">
        <script>
